        ...
        <div className="max-w-7xl mx-auto px-4 py-4 flex justify-between items-center">
          ...
          <div className="flex items-center space-x-8">
            ...
            <nav className="hidden md:flex space-x-6">
              {navigation.map((item) => (
                <Link key={item.name} to={item.href} className="text-gray-600 hover:text-blue-600 font-medium">
                  {item.name}
                </Link>
              ))}
            </nav>
          ...
          <div className="flex space-x-4">
            <Link to="/login" className="px-4 py-2 text-gray-600 hover:text-blue-600 border border-transparent hover:border-blue-600 rounded-lg">
              Login
            </Link>
